...
<!-- Mirrored from www.iitg.ernet.in/civil/site/?page_id=59 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Feb 2018 04:23:47 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<?php
 include("head.php");
?>
<body class="page-template page-template-page-templates page-template-inner-page page-template-page-templatesinner-page-php page page-id-59">
...
<li>Our mission is to provide acceptable quality engineering programmes to provide technical supports to industrial community and to contribute in community development.</li>
<li>Enhancing teaching learning quality to global standards.</li>
<li>Improving student teacher relationship.?>
<li>Enhancing resource utilization.</li>
<h5><strong>Quality Policies</strong></h5>
<p>Achieving competency with promoting research oriented culture, enhancing employability and empowered thinking ability through quality teaching-learning process.</p>
</ul>
</div>
</div>
</section>
...
<ul class="sub-menu">
	<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-59 current_page_item menu-item-111"><a href="indexc4a7.php?page_id=59">Objectives</a></li>
